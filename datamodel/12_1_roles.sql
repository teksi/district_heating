...
REVOKE ALL ON SCHEMA tdh_app  FROM tdh_viewer;
...
REVOKE ALL ON ALL TABLES IN SCHEMA tdh_app  FROM tdh_viewer;
...
ALTER DEFAULT PRIVILEGES IN SCHEMA tdh_app REVOKE ALL ON TABLES  FROM tdh_viewer;
*/
