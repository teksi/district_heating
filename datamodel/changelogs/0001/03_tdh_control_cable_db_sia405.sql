...
(
   ...
   CONSTRAINT pkey_tdh_od_sia405cc_cable_point_obj_id PRIMARY KEY (obj_id)
)
WITH (
   OIDS = False
);
CREATE SEQUENCE tdh_od.seq_sia405cc_cable_point_oid INCREMENT 1 MINVALUE 0 MAXVALUE 999999 START 0;
 ALTER TABLE tdh_od.sia405cc_cable_point ALTER COLUMN obj_id SET DEFAULT tdh_sys.generate_oid('tdh_od','sia405cc_cable_point');
COMMENT ON COLUMN tdh_od.sia405cc_cable_point.obj_id IS 'INTERLIS STANDARD OID (with Postfix/Präfix), see www.interlis.ch';
...
COMMENT ON COLUMN tdh_od.sia405cc_cable_point.horizontal_positioning IS '';
 ALTER TABLE tdh_od.sia405cc_cable_point ADD COLUMN altitude  decimal(7,3) ;
COMMENT ON COLUMN tdh_od.sia405cc_cable_point.altitude IS '';
 ALTER TABLE tdh_od.sia405cc_cable_point ADD COLUMN elevation_determination  integer ;
COMMENT ON COLUMN tdh_od.sia405cc_cable_point.elevation_determination IS '';
 ALTER TABLE tdh_od.sia405cc_cable_point ADD COLUMN status  integer ;
COMMENT ON COLUMN tdh_od.sia405cc_cable_point.status IS 'Operating and planning status of the structure / Betriebs- bzw. Planungszustand des Bauwerks / Etat de fonctionnement et de planification de l’ouvrage';
 ALTER TABLE tdh_od.sia405cc_cable_point ADD COLUMN installation_year  smallint ;
COMMENT ON COLUMN tdh_od.sia405cc_cable_point.installation_year IS '';
 ALTER TABLE tdh_od.sia405cc_cable_point ADD COLUMN sur_plus_cover  decimal(4,1) ;
COMMENT ON COLUMN tdh_od.sia405cc_cable_point.sur_plus_cover IS '';
 ALTER TABLE tdh_od.sia405cc_cable_point ADD COLUMN condition text;
 ALTER TABLE tdh_od.sia405cc_cable_point ADD CONSTRAINT _condition_length_max_40 CHECK(char_length(condition)<=40);
COMMENT ON COLUMN tdh_od.sia405cc_cable_point.condition IS '';
 ALTER TABLE tdh_od.sia405cc_cable_point ADD COLUMN remark text;
 ALTER TABLE tdh_od.sia405cc_cable_point ADD CONSTRAINT _remark_length_max_80 CHECK(char_length(remark)<=80);
COMMENT ON COLUMN tdh_od.sia405cc_cable_point.remark IS 'General remarks / Allgemeine Bemerkungen / Remarques générales';
 ALTER TABLE tdh_od.sia405cc_cable_point ADD COLUMN dimension1  smallint ;
COMMENT ON COLUMN tdh_od.sia405cc_cable_point.dimension1 IS '';
...
COMMENT ON COLUMN tdh_od.sia405cc_cable_point.last_modification IS 'Last modification / Letzte_Aenderung / Derniere_modification: INTERLIS_1_DATE';
 ALTER TABLE tdh_od.sia405cc_cable_point ADD COLUMN fk_dataowner varchar(16);
...
-------
-------
CREATE TABLE tdh_od.sia405cc_cable
(
   obj_id varchar(16) NOT NULL,
   CONSTRAINT pkey_tdh_od_cable_obj_id PRIMARY KEY (obj_id)
)
WITH (
   OIDS = False
);
CREATE SEQUENCE tdh_od.seq_cable_oid INCREMENT 1 MINVALUE 0 MAXVALUE 999999 START 0;
 ALTER TABLE tdh_od.sia405cc_cable ALTER COLUMN obj_id SET DEFAULT tdh_sys.generate_oid('tdh_od','sia405cc_cable');
COMMENT ON COLUMN tdh_od.sia405cc_cable.obj_id IS 'INTERLIS STANDARD OID (with Postfix/Präfix), see www.interlis.ch';
...
COMMENT ON COLUMN tdh_od.sia405cc_cable.status IS '';
 ALTER TABLE tdh_od.sia405cc_cable ADD COLUMN installation_year  smallint ;
COMMENT ON COLUMN tdh_od.sia405cc_cable.installation_year IS '';
 ALTER TABLE tdh_od.sia405cc_cable ADD COLUMN sur_plus_cover  decimal(4,1) ;
COMMENT ON COLUMN tdh_od.sia405cc_cable.sur_plus_cover IS '';
 ALTER TABLE tdh_od.sia405cc_cable ADD COLUMN condition text;
 ALTER TABLE tdh_od.sia405cc_cable ADD CONSTRAINT _condition_length_max_40 CHECK(char_length(condition)<=40);
COMMENT ON COLUMN tdh_od.sia405cc_cable.condition IS '';
 ALTER TABLE tdh_od.sia405cc_cable ADD COLUMN remark text;
 ALTER TABLE tdh_od.sia405cc_cable ADD CONSTRAINT _remark_length_max_80 CHECK(char_length(remark)<=80);
...
COMMENT ON COLUMN tdh_od.sia405cc_cable.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
...
ALTER TABLE tdh_od.sia405cc_cable_point ADD COLUMN fk_owner varchar(16);
ALTER TABLE tdh_od.sia405cc_cable_point ADD CONSTRAINT rel_sia405cc_cable_point_owner FOREIGN KEY (fk_owner) REFERENCES tdh_od.organisation(obj_id) ON UPDATE CASCADE ON DELETE set null DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE tdh_vl.sia405cc_cable_point_kind ADD CONSTRAINT pkey_tdh_vl_sia405cc_cable_point_kind_code PRIMARY KEY (code);
 ...
 ALTER TABLE tdh_od.sia405cc_cable_point ADD CONSTRAINT fkey_vl_sia405cc_cable_point_kind FOREIGN KEY (kind)
...
ALTER TABLE tdh_vl.sia405cc_cable_point_horizontal_positioning ADD CONSTRAINT pkey_tdh_vl_sia405cc_cable_point_horizontal_positioning_code PRIMARY KEY (code);
 ...
 ALTER TABLE tdh_od.sia405cc_cable_point ADD CONSTRAINT fkey_vl_sia405cc_cable_point_horizontal_positioning FOREIGN KEY (horizontal_positioning)
...
ALTER TABLE tdh_vl.sia405cc_cable_point_elevation_determination ADD CONSTRAINT pkey_tdh_vl_sia405cc_cable_point_elevation_determination_code PRIMARY KEY (code);
 ...
 ALTER TABLE tdh_od.sia405cc_cable_point ADD CONSTRAINT fkey_vl_sia405cc_cable_point_elevation_determination FOREIGN KEY (elevation_determination)
...
ALTER TABLE tdh_vl.sia405cc_cable_point_status ADD CONSTRAINT pkey_tdh_vl_sia405cc_cable_point_status_code PRIMARY KEY (code);
 ...
 ALTER TABLE tdh_od.sia405cc_cable_point ADD CONSTRAINT fkey_vl_sia405cc_cable_point_status FOREIGN KEY (status)
 REFERENCES tdh_vl.sia405cc_cable_point_status (code) MATCH SIMPLE
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE tdh_od.sia405cc_cable ADD COLUMN fk_owner varchar(16);
ALTER TABLE tdh_od.sia405cc_cable ADD CONSTRAINT rel_cable_owner FOREIGN KEY (fk_owner) REFERENCES tdh_od.organisation(obj_id) ON UPDATE CASCADE ON DELETE set null DEFERRABLE INITIALLY DEFERRED;
CREATE TABLE tdh_vl.sia405cc_cable_function () INHERITS (tdh_vl.value_list_base);
ALTER TABLE tdh_vl.sia405cc_cable_function ADD CONSTRAINT pkey_tdh_vl_cable_function_code PRIMARY KEY (code);
 ...
 ALTER TABLE tdh_od.sia405cc_cable ADD CONSTRAINT fkey_vl_cable_function FOREIGN KEY (function)
...
ALTER TABLE tdh_vl.sia405cc_cable_cable_type ADD CONSTRAINT pkey_tdh_vl_cable_cable_type_code PRIMARY KEY (code);
 ...
 ALTER TABLE tdh_od.sia405cc_cable ADD CONSTRAINT fkey_vl_cable_cable_type FOREIGN KEY (cable_type)
...
ALTER TABLE tdh_vl.sia405cc_cable_horizontal_positioning ADD CONSTRAINT pkey_tdh_vl_cable_horizontal_positioning_code PRIMARY KEY (code);
 ...
 ALTER TABLE tdh_od.sia405cc_cable ADD CONSTRAINT fkey_vl_cable_horizontal_positioning FOREIGN KEY (horizontal_positioning)
...
ALTER TABLE tdh_vl.sia405cc_cable_status ADD CONSTRAINT pkey_tdh_vl_cable_status_code PRIMARY KEY (code);
 ...
 ALTER TABLE tdh_od.sia405cc_cable ADD CONSTRAINT fkey_vl_cable_status FOREIGN KEY (status)
...
ALTER TABLE tdh_vl.sia405cc_cable_elevation_determination ADD CONSTRAINT pkey_tdh_vl_cable_elevation_determination_code PRIMARY KEY (code);
 ...
 ALTER TABLE tdh_od.sia405cc_cable ADD CONSTRAINT fkey_vl_cable_elevation_determination FOREIGN KEY (elevation_determination)
...
ALTER TABLE tdh_od.sia405cc_cable_point ADD CONSTRAINT rel_od_sia405cc_cable_point_fk_dataowner FOREIGN KEY (fk_dataowner) REFERENCES tdh_od.organisation(obj_id);
ALTER TABLE tdh_od.sia405cc_cable_point ADD CONSTRAINT rel_od_sia405cc_cable_point_fk_dataprovider FOREIGN KEY (fk_provider) REFERENCES tdh_od.organisation(obj_id);
ALTER TABLE tdh_od.sia405cc_cable ADD CONSTRAINT rel_od_cable_fk_dataowner FOREIGN KEY (fk_dataowner) REFERENCES tdh_od.organisation(obj_id);
ALTER TABLE tdh_od.sia405cc_cable ADD CONSTRAINT rel_od_cable_fk_dataprovider FOREIGN KEY (fk_provider) REFERENCES tdh_od.organisation(obj_id);
