...
ALTER TABLE tdh_vl.pipe_point_normal_kind ADD CONSTRAINT pkey_tdh_vl_pipe_point_normal_kind_code PRIMARY KEY (code);
 ...
 INSERT INTO tdh_vl.pipe_point_normal_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (8111,8111,'armatures.gate_valve_with_motor.with_remote_control','Armaturen.Schieber_mit_Motor.mit_Fernsteuerung','armatures.vanne_motorisee.avec_commande_a_distance', 'zzz_Armaturen.Schieber_mit_Motor.mit_Fernsteuerung', 'rrr_Armaturen.Schieber_mit_Motor.mit_Fernsteuerung', '', '', '', '', '', 'true');
 INSERT INTO tdh_vl.pipe_point_normal_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (8112,8112,'armatures.gate_valve_with_motor.without_remote_control','Armaturen.Schieber_mit_Motor.ohne_Fernsteuerung','armatures.vanne_motorisee.sans_commande_a_distance', 'zzz_Armaturen.Schieber_mit_Motor.ohne_Fernsteuerung', 'rrr_Armaturen.Schieber_mit_Motor.ohne_Fernsteuerung', '', '', '', '', '', 'true');
 INSERT INTO tdh_vl.pipe_point_normal_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (8110,8110,'armatures.gate_valve_without_motor','Armaturen.Schieber_ohne_Motor','armatures.vanne_non_motorisee', 'zzz_Armaturen.Schieber_ohne_Motor', 'rrr_Armaturen.Schieber_ohne_Motor', '', '', '', '', '', 'true');
