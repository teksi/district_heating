...
class TestGeometry(unittest.TestCase, DbTestBase):
    ...
    # to do add geometry tests for Distance Heating

    # def test_vw_tdh_reach_geometry_insert(self):
    ...
    # "rp_to_level": None,
    # }
    # self.insert_check("vw_tdh_reach", row, expected_row)
    # # reach_point has on rp_to as Z NaN: SELECT ST_SetSRID( ST_MakePoint(1,2,'NaN'), 2056)
    # row = self.select("reach_point", "BBB 1337_0001", schema="tdh_od")
    ...
    # row = self.select("reach_point", "CCC 1337_0001", schema="tdh_od")
    # assert row["situation3d_geometry"] == self.execute(
    # f"ST_SetSRID( ST_MakePoint({X + 3}, {Y + 3},'NaN'), 2056)"
    # )

    # # 2. insert geometry with Z and no rp_from_level and 66 as rp_to_level
    # # INSERT INTO tdh_app.vw_tdh_reach (obj_id, progression3d_geometry, rp_to_level, rp_from_obj_id, rp_to_obj_id) VALUES ('AAA 1337_0002', ST_SetSRID(ST_GeomFromText('COMPOUNDCURVE Z ((1 2 3,4 5 6,7 8 9))'), 2056), 66, 'BBB 1337_0002', 'CCC 1337_0002' );
    # row = {
    ...
    # # vw_tdh_reach has the geometry but NaN as Z on start_point and 66 (rp_to_level) as Z on end_point: SELECT ST_SetSRID( ST_ForceCurve(ST_MakeLine(ARRAY[ST_MakePoint(1,2,'NaN'), ST_MakePoint(4,5,6), ST_MakePoint(7,8,66)])), 2056)
    ...
    # row = self.select("reach_point", "BBB 1337_0002", schema="tdh_od")
    # assert (
    ...
    # row = self.select("reach_point", "CCC 1337_0002", schema="tdh_od")
    # assert (
    # row["situation3d_geometry"]
    ...
    # # INSERT INTO tdh_app.vw_tdh_reach (obj_id, progression3d_geometry, rp_from_level, rp_to_level, rp_from_obj_id, rp_to_obj_id) VALUES ('AAA 1337_0003', ST_SetSRID(ST_GeomFromText('COMPOUNDCURVE Z ((1 2 3,4 5 6,7 8 9))'), 2056), NULL, 77, 'BBB 1337_0003', 'CCC 1337_0003' );
    # row = {
    # "progression3d_geometry": "01090000A00808000001000000010200008003000000000000000000F03F000000000000004000000000000008400000000000001040000000000000144000000000000018400000000000001C4000000000000020400000000000002240",
    ...
    # }
    # expected_row = copy.deepcopy(row)
    # # vw_tdh_reach has the geometry but 77 (rp_from_level) as Z on start_point and NaN as Z on end_point: SELECT ST_SetSRID( ST_ForceCurve(ST_MakeLine(ARRAY[ST_MakePoint(1,2,77), ST_MakePoint(4,5,6), ST_MakePoint(7,8,'NaN')])), 2056)
    # expected_row["progression3d_geometry"] = (
    ...
    # row = self.select("reach_point", "BBB 1337_0003", schema="tdh_od")
    # assert (
    # row["situation3d_geometry"]
    ...
    # row = self.select("reach_point", "CCC 1337_0003", schema="tdh_od")
    # assert (
    # row["situation3d_geometry"]
    # == "01010000A0080800000000000000001C400000000000002040000000000000F87F"
    # )

    # def test_vw_tdh_reach_geometry_update(self):
    # # first insert
    # # no Z and no rp_from_level and no rp_to_level
    # # INSERT INTO tdh_app.vw_tdh_reach (progression3d_geometry, rp_from_obj_id, rp_to_obj_id) VALUES (ST_SetSRID( ST_ForceCurve(ST_MakeLine(ARRAY[ST_MakePoint(1,2,'NaN'), ST_MakePoint(4,5,'NaN'), ST_MakePoint(7,8,'NaN')])), 2056), 'BBB 1337_1010', 'CCC 1337_1010' );
    # row = {
    ...
    # }
    # obj_id = self.insert("vw_tdh_reach", row)

    # # 1. change geometry including Z with startpoint Z 3 and endpoint Z 9, no change on rp_from_level, no change on rp_to_level
    # # UPDATE INTO tdh_app.vw_tdh_reach SET progression3d_geometry=ST_SetSRID(ST_GeomFromText('COMPOUNDCURVE Z ((1 2 3,4 5 6,7 8 9))'), 2056) WHERE obj_id=obj_id'
    # row = {
    # "progression3d_geometry": "01090000A00808000001000000010200008003000000000000000000F03F000000000000004000000000000008400000000000001040000000000000144000000000000018400000000000001C4000000000000020400000000000002240"
    # }
    # self.update("vw_tdh_reach", row, obj_id)
    # new_row = self.select("vw_tdh_reach", obj_id)
    # # vw_tdh_reach has the geometry
    # assert (
    ...
    # new_row = self.select("reach_point", "BBB 1337_1010", schema="tdh_od")
    # assert new_row["level"] == 3
    # # reach_point has on rp_to as Z 9
    # new_row = self.select("reach_point", "CCC 1337_1010", schema="tdh_od")
    ...
    # # UPDATE INTO tdh_app.vw_tdh_reach SET progression3d_geometry=ST_SetSRID(ST_GeomFromText('COMPOUNDCURVE Z ((1 2 33,4 5 6,7 8 99))'), 2056), rp_to_level=NULL WHERE obj_id=obj_id'
    # row = {
    ...
    # self.update("vw_tdh_reach", row, obj_id)
    # new_row = self.select("vw_tdh_reach", obj_id)
    # # vw_tdh_reach has the geometry but as endpoint Z there is NaN: SELECT ST_SetSRID( ST_ForceCurve(ST_MakeLine(ARRAY[ST_MakePoint(1,2,33), ST_MakePoint(4,5,6), ST_MakePoint(7,8,'NaN')])), 2056)
    # assert (
    # new_row["progression3d_geometry"]
    ...
    # # UPDATE INTO tdh_app.vw_tdh_reach SET progression3d_geometry=ST_SetSRID(ST_GeomFromText('COMPOUNDCURVE Z ((1 2 300,4 5 6,7 8 900))'), 2056), rp_to_level=NULL WHERE obj_id=obj_id'
    # row = {
    ...
    # self.update("vw_tdh_reach", row, obj_id)
    # new_row = self.select("vw_tdh_reach", obj_id)
    # # vw_tdh_reach has the geometry but as startpoint Z is 333 and on endpoint Z is 999: SELECT ST_SetSRID( ST_ForceCurve(ST_MakeLine(ARRAY[ST_MakePoint(1,2,333), ST_MakePoint(4,5,6), ST_MakePoint(7,8,'999)])), 2056)
    # assert (
    # new_row["progression3d_geometry"]
    ...
    # # UPDATE INTO tdh_app.vw_tdh_reach SET progression3d_geometry=ST_SetSRID( ST_ForceCurve(ST_MakeLine(ARRAY[ST_MakePoint(1,2,'NaN'), ST_MakePoint(4,5,6), ST_MakePoint(7,8,'NaN')])), 2056) WHERE obj_id=obj_id'
    # row = {
    ...
    # def test_vw_tdh_xxx_structure_geometry_insert(self):
    # # 1. insert geometry and no co_level and no wn_bottom_level
    # # INSERT INTO tdh_app.vw_tdh_xxx_structure (situation3d_geometry, wn_obj_id, co_obj_id) VALUES (ST_SetSRID(ST_MakePoint(2600000, 1200000), 2056), '1337_1001', '1337_1001');
    # row = {
    ...
    # }
    # expected_row = copy.deepcopy(row)
    # # xxxstructure has the geometry but NaN as Z because of no co_level (geometry of cover): ST_SetSRID(ST_Collect(ST_MakePoint(2600000, 1200000, 'NaN')), 2056)
    ...
    # self.insert_check("vw_tdh_xxx_structure", row, expected_row)
    # # cover geometry has the geometry but NaN as Z: ST_SetSRID(ST_MakePoint(2600000, 1200000, 'NaN'), 2056)
    # row = self.select("cover", "1337_1001", schema="tdh_od")
    # assert (
    # row["situation3d_geometry"]
    # == "01010000A0080800000000000020D6434100000000804F3241000000000000F87F"
    # )
    # # xxx_node has the geometry but not 3d: ST_SetSRID(ST_MakePoint(2600000, 1200000), 2056)
    # row = self.select("xxx_node", "1337_1001", schema="tdh_od")
    # assert row["situation3d_geometry"] == self.execute(
    # "ST_SetSRID( ST_MakePoint(2600000, 1200000, 'NaN'), 2056)"
    # )

    # # 2. insert geometry with no co_level and WITH wn_bottom_level
    # # INSERT INTO tdh_app.vw_tdh_xxx_structure (situation3d_geometry, wn_obj_id, co_obj_id, wn_bottom_level) VALUES (ST_SetSRID(ST_MakePoint(2600000, 1200000), 2056), '1337_1002', '1337_1002', 200.000);
    # row = {
    # "situation3d_geometry": "0101000020080800000000000020D6434100000000804F3241",
    # "wn_obj_id": "1337_1002",
    # "co_obj_id": "1337_1002",
    ...
    # }
    # expected_row = copy.deepcopy(row)
    # # xxxstructure has the 2D geometry: ST_SetSRID(ST_MakePoint(2600000, 1200000), 2056)
    # expected_row["situation3d_geometry"] = "0101000020080800000000000020D6434100000000804F3241"
    # # co_level is NULL
    # expected_row["co_level"] = None
    ...
    # self.insert_check("vw_tdh_xxx_structure", row, expected_row)
    # # cover geometry has the geometry but NaN as Z: ST_SetSRID(ST_MakePoint(2600000, 1200000, 'NaN'), 2056)
    # row = self.select("cover", "1337_1002", schema="tdh_od")
    # assert (
    # row["situation3d_geometry"]
    # == "01010000A0080800000000000020D6434100000000804F3241000000000000F87F"
    # )
    # # xxx_node has the geometry and  wn_buttom_level as Z: ST_SetSRID(ST_MakePoint(2600000, 1200000, 200), 2056)
    # row = self.select("xxx_node", "1337_1002", schema="tdh_od")
    # assert (
    # row["situation3d_geometry"]
    ...
    # # INSERT INTO tdh_app.vw_tdh_xxx_structure (situation3d_geometry, wn_obj_id, co_obj_id, wn_bottom_level, co_level) VALUES (ST_SetSRID(ST_MakePoint(2600000, 1200000), 2056), '1337_1003', '1337_1003', 200.000, 500.000);
    # row = {
    # "situation3d_geometry": "0101000020080800000000000020D6434100000000804F3241",
    # "wn_obj_id": "1337_1003",
    # "co_obj_id": "1337_1003",
    ...
    # }
    # expected_row = copy.deepcopy(row)
    # # xxxstructure has 2D geometry: ST_SetSRID(ST_MakePoint(2600000, 1200000), 2056)
    # expected_row["situation3d_geometry"] = "0101000020080800000000000020D6434100000000804F3241"
    ...
    # row = self.select("cover", "1337_1003", schema="tdh_od")
    # assert (
    # row["situation3d_geometry"]
    # == "01010000A0080800000000000020D6434100000000804F32410000000000407F40"
    # )
    # # xxx_node has the geometry and wn_buttom_level as Z: ST_SetSRID(ST_MakePoint(2600000, 1200000, 200), 2056)
    # row = self.select("xxx_node", "1337_1003", schema="tdh_od")
    # assert (
    # row["situation3d_geometry"]
    # == "01010000A0080800000000000020D6434100000000804F32410000000000006940"
    # )

    # def test_vw_tdh_xxx_structure_geometry_update(self):
    # # first insert
    # # insert geometry with no co_level and no wn_bottom_level
    # # INSERT INTO tdh_app.vw_tdh_xxx_structure (situation3d_geometry, wn_obj_id, co_obj_id) VALUES (ST_SetSRID(ST_MakePoint(2600000, 1200000), 2056), '1337_1010', '1337_1010');
    # row = {
    # "situation3d_geometry": "0101000020080800000000000020D6434100000000804F3241",
    # "ws_type": "manhole",
    # "wn_obj_id": "1337_1010",
    # "co_obj_id": "1337_1010",
    # }
    # obj_id = self.insert("vw_tdh_xxx_structure", row)
    ...
    # self.update("vw_tdh_xxx_structure", row, obj_id)
    # new_row = self.select("vw_tdh_xxx_structure", obj_id)
    # # no change on geometry of xxxstructure (because it's geometry of cover that does not change)
    # self.assertEqual(
    ...
    # new_row = self.select("cover", "1337_1010", schema="tdh_od")
    # assert (
    # new_row["situation3d_geometry"]
    # == "01010000A0080800000000000020D6434100000000804F3241000000000000F87F"
    # )
    # # xxx_node geometry has Z from new wn_bottom_level: ST_SetSRID(ST_MakePoint(2600000, 1200000, 200), 2056)
    # new_row = self.select("xxx_node", "1337_1010", schema="tdh_od")
    # assert (
    # new_row["situation3d_geometry"]
    # == "01010000A0080800000000000020D6434100000000804F32410000000000006940"
    # )
    ...
    # self.update("vw_tdh_xxx_structure", row, obj_id)
    # new_row = self.select("vw_tdh_xxx_structure", obj_id)
    # # geometry of xxxstructure has 2D geometry: ST_SetSRID(ST_MakePoint(2600000, 1200000, 500), 2056)
    # assert (
    # new_row["situation3d_geometry"] == "0101000020080800000000000020D6434100000000804F3241"
    # )
    # # co_level is new co_level
    ...
    # == "01010000A0080800000000000020D6434100000000804F32410000000000407F40"
    # )
    # # no change on xxx_node geometry: ST_SetSRID(ST_MakePoint(2600000, 1200000, 200), 2056)
    # new_row = self.select("xxx_node", "1337_1010", schema="tdh_od")
    # assert (
    # new_row["situation3d_geometry"]
    # == "01010000A0080800000000000020D6434100000000804F32410000000000006940"
    ...
    # self.update("vw_tdh_xxx_structure", row, obj_id)
    # new_row = self.select("vw_tdh_xxx_structure", obj_id)
    # # geometry of xxxstructure unchanged: ST_SetSRID(ST_MakePoint(2600000, 1200000), 2056)
    # assert (
    # new_row["situation3d_geometry"] == "0101000020080800000000000020D6434100000000804F3241"
    # )
    # # co_level is new co_level
    ...
    # )
    # # no change on xxx_node geometry: ST_SetSRID(ST_MakePoint(2600000, 1200000, 300), 2056)
    # new_row = self.select("xxx_node", "1337_1010", schema="tdh_od")
    # assert (
    # new_row["situation3d_geometry"]
    ...
    def test_pipe_point_geometry_sync_on_insert(self):
        ...
        # INSERT INTO tdh_app.vw_tdh_pipe_point (pp_type, altitude1, geometry3d_geometry) VALUES ('pipe_point_normal', 200, ST_SetSRID(ST_MakePoint(2600000, 1200000, 'NaN'), 2056) );
        row = {
            "pp_type": "pipe_point_normal",  # added pp_type, to not create hint
            "altitude1": "200.000",
        ...
        expected_row["altitude1"] = "200.000"
    ...
    # "01010000A0080800000000000020D6434100000000804F32410000000000006940"
    # )
    # self.insert_check("vw_xxx_node", row, expected_row)

    # # 3. bottom level NULL and 555 Z
    # # INSERT INTO tdh_app.vw_xxx_node (bottom_level, situation3d_geometry) VALUES (NULL, ST_SetSRID(ST_MakePoint(2600000, 1200000, 555), 2056) );
    # row = {
    # "bottom_level": None,
    # "situation3d_geometry": "01010000A0080800000000000020D6434100000000804F32410000000000588140",
    # }
    ...
    # # INSERT INTO tdh_app.vw_xxx_node (situation3d_geometry) VALUES (ST_SetSRID(ST_MakePoint(2600000, 1200000, 555), 2056) );
    # row = {
    # "situation3d_geometry": "01010000A0080800000000000020D6434100000000804F32410000000000588140",
    # }
    # expected_row = copy.deepcopy(row)
    ...
    # def test_xxx_node_geometry_sync_on_update(self):
    # # first insert
    # # no bottom level and no Z
    # # INSERT INTO tdh_app.vw_xxx_node (bottom_level, situation3d_geometry) VALUES (200, ST_SetSRID(ST_MakePoint(2600000, 1200000, 'NaN'), 2056) );
    # row = {
    # "situation3d_geometry": "01010000A0080800000000000020D6434100000000804F3241000000000000F87F",
    # }
    # obj_id = self.insert("vw_xxx_node", row)
    ...
    # "situation3d_geometry": "01010000A0080800000000000020D6434100000000804F32410000000000588140",
    # }
    # self.update("vw_xxx_node", row, obj_id)
    # # Z (555) overwrites bottom_level results in: 555.000
    # new_row = self.select("vw_xxx_node", obj_id)
    # assert (
    # new_row["situation3d_geometry"]
    ...
    # # INSERT INTO tdh_app.vw_cover (level, situation3d_geometry) VALUES (200, ST_SetSRID(ST_MakePoint(2600000, 1200000, 'NaN'), 2056) );
    # row = {
    # "level": "200.000",
    # "situation3d_geometry": "01010000A0080800000000000020D6434100000000804F3241000000000000F87F",
    # }
    ...
    # # INSERT INTO tdh_app.vw_cover (level, situation3d_geometry) VALUES (200, ST_SetSRID(ST_MakePoint(2600000, 1200000, 555), 2056) );
    # row = {
    # "level": "200.000",
    # "situation3d_geometry": "01010000A0080800000000000020D6434100000000804F32410000000000588140",
    # }
    ...
    # # INSERT INTO tdh_app.vw_cover (level, situation3d_geometry) VALUES (NULL, ST_SetSRID(ST_MakePoint(2600000, 1200000, 555), 2056) );
    # row = {
    # "level": None,
    # "situation3d_geometry": "01010000A0080800000000000020D6434100000000804F32410000000000588140",
    # }
    ...
    # # INSERT INTO tdh_app.vw_cover (situation3d_geometry) VALUES (ST_SetSRID(ST_MakePoint(2600000, 1200000, 555), 2056) );
    # row = {
    # "situation3d_geometry": "01010000A0080800000000000020D6434100000000804F32410000000000588140",
    # }
    # expected_row = copy.deepcopy(row)
    ...
    # # UPDATE INTO tdh_app.vw_cover SET situation3d_geometry=ST_SetSRID(ST_MakePoint(2600000, 1200000, 555), 2056) WHERE obj_id = obj_id;
    # row = {
    # "situation3d_geometry": "01010000A0080800000000000020D6434100000000804F32410000000000588140",
    # }
    ...
    # # UPDATE INTO tdh_app.vw_cover SET level=200 WHERE obj_id = obj_id;
    # row = {"level": "200.000"}
    # self.update("vw_cover", row, obj_id)
    ...
    # # UPDATE tdh_od.cover_node SET level=200 WHERE obj_id = obj_id;
    # row = {
    # "level": "555.000",
    # "situation3d_geometry": "01010000A0080800000000000020D6434100000000804F32410000000000D08440",
    # }
    ...
    # # UPDATE INTO tdh_app.vw_cover SET situation3d_geometry=ST_SetSRID(ST_MakePoint(2600000, 1200000, 'NaN'), 2056) WHERE obj_id = obj_id;
    # row = {
    # "situation3d_geometry": "01010000A0080800000000000020D6434100000000804F3241000000000000F87F",
    # }
    # self.update("vw_cover", row, obj_id)
